...
import { LastLayerDiagram, CubeNet } from '../components/CubeDiagram';
import { buildDrill } from '../algs/drill';
...
export function CasePicture({
  ...
  return (
    <figure className="lesson-case">
      {setId === 'f2l' ? (
        <CubeNet cube={drill.state} cell={10} />
      ) : (
        <LastLayerDiagram cube={drill.cubie} mode={setId === 'oll' ? 'orientation' : 'permutation'} cell={20} />
      )}
      <figcaption>
